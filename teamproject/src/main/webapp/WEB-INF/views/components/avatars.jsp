						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<p class="demo">
										<div class="avatar">
											<img src="../../../resources/img/jm_denis.jpg" alt="..." class="avatar-img rounded">
										</div>
								...
								<div class="card-body">
									<p class="demo">
										<div class="avatar-group">
											<div class="avatar">
												<img src="../../../resources/img/jm_denis.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="../../../resources/img/chadengle.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="../../../resources/img/mlane.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
